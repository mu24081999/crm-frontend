...
import { getMessagesLogs } from "../../redux/services/message";

const MessagesLogsContent = () => {
  const {
    handleSubmit,
    watch,
    control,
  ...
  console.log("🚀 ~ MessagesLogsContent ~ messages:", messages);
...
export default MessagesLogsContent;
