            ...
            <div data-simplebar className="nicescroll-bar">
              <div className="menu-content-wrap">
                ...
                <div className="d-flex align-items-center justify-content-between mb-2">
                  <div className="title-sm text-primary mb-0">
                    Favourite Boards
                  </div>
                  <a
                    href="/"
                          ...
                          <div className="tasklist-handle">
                            ...
                            <div className="card-action-wrap">
                              ...
                              >
                                ...
                                <a
                                  className="dropdown-item delete-tasklist"
                                  href="/"
                                >
                                  Delete
                                </a>
                                <a
                                  className="dropdown-item clear-tasklist"
                                  href="/"
                                >
                                  Clear All
                                </a>
                              ...
                              <div className="media">
                                ...
                                <div className="media-body">
                                  <p>
                                    ...
                                    moved components from all modules to in
                                    progress
                                  </p>
                                  <div className="last-activity-time">
                                    Sep 10, 2021, 10:13 AM
                            ...
                            <div className="media">
                              ...
                              <div className="media-body">
                                ...
                                <p>
                                  ...
                                  your contracts, deploy those contracts to the
                                  network, and run their associated unit tests.
                                </p>
                                      ...
                                      <div className="media">
                                        ...
                                        <div className="media-body">
                                          <p>
                                            ...
                                            created a note on UI components task
                                            list
                                          </p>
                                          <div className="last-activity-time">
                                            Sep 2, 2021, 9:23 AM
                                      ...
                                      <div className="media">
                                        ...
                                        <div className="media-body">
                                          <p>
                                            ...
                                            moved components from all modules to
                                            in progress
                                          </p>
                                          <div className="last-activity-time">
                                            Sep 10, 2021, 10:13 AM
