                  ...
                  <div className="w-100">
                    <div className="row">
                      <div className="col-xxl-9 col-xl-8 col-lg-11">
                        ...
                        <p className="p-lg">
                          You have not completed your KYC Details
                        </p>
                        <Link to="/kyc-form" className="btn btn-primary mt-4">
                          Return back and add details
                        </Link>
                      </div>
                    </div>
                  </div>
...
export default KYCNeededContent;
