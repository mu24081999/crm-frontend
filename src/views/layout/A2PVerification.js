...
import { storeVerification } from "../../redux/services/verification";
              ...
              {isLoading ? (
                ...
                <div class="modal-body row">
                  <div className="col-md-12 col-sm-6">
                    ...
                    />
                    <p className="mb-5">
                      If you're registering a US entity, please enter the exact
                      legal business name as registered with the EIN, which can
                      be found on the CP 575 EIN Confirmation Letter.
                    </p>
                  </div>
                  ...
                  <div className="col-md-12 col-sm-6">
                    <ReactSelectField
                      ...
                      options={[
                        {
                          label:
                            "Low Volume Standard Brand $4 one type fee. 6000 sms per day",
                          value: "standard",
                        },
                        {
                          label:
